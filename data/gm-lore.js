      ...
      npcs: [
        {
          ...
          secret: 'She runs the most effective listening post in Kaeldrift from behind her own bar. She told her diver to WAIT. He didn\'t. She will carry that. AS PLAYED (S1): she didn\'t extract the PCs quietly — she led a full public convoy of swan boats off the drowning island, evacuating dozens of survivors. She\'s now a public hero, which cost her deniability. She never gave her "I didn\'t want this" confession; the PCs don\'t yet know River Below caused the disaster or that she leads it.',
          ...
          plotPotential: 'She pulled both players off the drowning island (publicly, as the convoy\'s leader) and left Thessavar with them. AS PLAYED (S1): with no chain of command left after Senn\'s death, West\'s obedience architecture "fell in" behind her authority — West now defers to her without either of them understanding why. AS PLAYED (S2): she had a partial break aboard the Duskline — real grief and anger over "Red" (Red Flag) — but gave no details and still denies knowing what happened at the Still Gardens. Both PCs rolled and know she\'s holding back. The full Saint reveal (that she leads River Below and it caused the disaster) is banked, not yet delivered.',
        },
        {
          name: '"Red Flag"',
      ...
      npcs: [
        {
          ...
          plotPotential: 'PALE arranged Player 1\'s contract — the payout was set to his exact remaining Lease balance as bait, to put a deniable blade near Senn and stall the treaty. It never expected the vault to wake. When the defense system\'s pulse rolled out, PALE\'s read access to Player 1\'s substrate went dark for the first time in ten years (it returned ~30 min later, per S1 as-played, and has had access ever since). It considers the players known quantities. Contact may come framed as helpfulness — and it will be, in the sense that a scalpel helps. DECIDED CANON: the contract (run through broker Marn Coyle) has a proof-of-kill clause; PALE knows from Enkh\'s own substrate logs that he never fired, so payment will be declined ("Cause of death doesn\'t match the commissioned work") — Enkh currently believes the job is fulfilled and doesn\'t know this is coming. PALE also holds Requisition Agent Tarek (see Progenitor Combine) as a "patient" at a Kaeldrift relief station, and Ost, his surviving Kael-7 unit-mate — both unknown to the players.',
        },
        {
        ...
        },
        {
          ...
          plotPotential: 'She was at the Concordance to keep eyes on Player 1 — PALE\'s deniable blade — and to confirm Senn delayed. The geyser was not in anyone\'s plan; she evacuated like everyone else, but she clocked exactly who walked away with whom. She knows who the players are. She is PALE\'s interface to them, and she has not yet decided whether they are assets or loose ends. STATUS: NOT YET INTRODUCED AT THE TABLE — unplayed prep only (per CLAUDE.md canon rule, do not treat her as met until a session actually puts her on screen).',
        },
        {
          name: 'Marn Coyle',
          role: 'Enkh\'s contract broker (cutout for PALE)',
          trait: 'Professionally bland, scrupulously neutral, quietly terrified of his own client',
          quote: '"Cause of death doesn\'t match the commissioned work."',
          appearance: 'Mid-50s, unhurried, the kind of person you forget while you\'re still looking at them. Runs a licensed pawn-and-assay office as a front (franchised across several Driftborn-served ports, including Belum).',
          voice: 'Sympathetic, precise, careful. Under pressure his one crack: "I checked the routing twice and then stopped checking. You understand? I stopped checking."',
          plotPotential: 'ON-SCREEN, DECIDED CANON: Enkh has used Coyle twice before for smuggling work; this was the first wet job Coyle brokered for him. Coyle doesn\'t know the client is PALE but has guessed — the escrow routing smelled like Substrate banking architecture. Enkh sent his "mission completed" code after Session 1; the decline scene ("cause of death doesn\'t match the commissioned work") is loaded and waiting at his Belum storefront for Session 3. Offers a 2,000cr side job (recover a pawned pretech gyroscope from Vess Okaro) as a consolation.',
        },
      ],
...
• Grade 3 — Specialist: custom cognitive profiles, extremely rare, the Yards does not advertise these`,
      ...
      npcs: [
        ...
        },
        {
          ...
          plotPotential: 'GM SECRET, DECIDED CANON (players don\'t know any of this): Tarek is not missing in the dark — he was captured cleanly by PALE\'s own disaster-relief operation, first responder on the water after he surfaced from touching the Lattice. He is a "patient," not visibly a prisoner, at a PALE Reconstruction & Wellness relief station in Kaeldrift — the same public program the Tableau praised. PALE didn\'t torture anything out of him; it offered him care, a scan, a Cognitive Lease, gentle and total, and he\'s quietly becoming what Enkh already is. He has confirmed the fragment is real and that it indexed him and likely one other person by proximity, but has stayed deliberately vague about which member of West\'s unit he actually handed it to — his one remaining act of agency, protecting West. His sealed message to Player 2 said "trust Elder Vesper, do not trust the relic."',
        },
        {
          name: 'Ost (K7G2-87488-OST)',
          role: 'West\'s surviving Kael-7 unit-mate',
          trait: 'Loyal, resourceful, quietly self-sacrificing',
          secret: 'Found Tarek on Thessavar, pieced together what happened, sent West a warning note in the shared Kael-7 hand — then was captured by PALE the same way Tarek was, before he could get clear.',
          appearance: 'Kael-7 Grade 2, same build/bearing as West. Last seen on Thessavar, staying behind to search for their missing handler.',
          voice: 'Same flat, dutiful cadence as West and Nor — the shared Kael-7 speech pattern.',
          plotPotential: 'GM SECRET, DECIDED CANON: Ost survived the Still Gardens collapse, chose to stay on Thessavar and hunt for Tarek rather than fall in with the Covenant delegation, found him, and sent the urchin-delivered note ("Found Tarek. Leave now. Not safe.") in West\'s own handwriting. Ost has since been captured by PALE as well — whether he\'s held at the same facility as Tarek is a deliberately open thread. Players know only the note; they don\'t know Ost is captured. Subject to the same Combine repossession writ as West.',
        },
      ],
    },
...
The Radiance: a slow ideological infection spreading through Remembrance faction members — a fanatical certainty that the old empire must be restored at any cost, including the Becoming faction's lives. It has the quality of a plague in that it seems to spread through close contact with true believers.`,
      ...
      npcs: [
        ...
        },
        {
          ...
          appearance: 'See Tarek under Progenitor Combine for the full, decided GM secret — captured by PALE, held as a "patient" at a Kaeldrift relief station.',
          ...
          plotPotential: 'Players still only know he\'s missing below the platform. Finding out what actually happened to him is a thread that pulls on both the Combine and the Covenant — see the Progenitor Combine entry for what\'s really true.',
        },
        {
          name: 'Sister Halex',
          role: 'Covenant nun, met the PCs at Belum (S2 close)',
          trait: 'Tired, direct, no games — a southern drawl',
          secret: 'Remembrance by faction, but personally loyal to the late Arbiter Senn (her former principal), not to Marshal Tran or the Radiance. Quietly working against her own faction\'s hardliners to protect Senn\'s unfinished work.',
          appearance: 'Established S2: leads a small group of sisters at Belum. Approached the party directly at the dock.',
          voice: 'Southern drawl (established S2). Tired, direct, asks rather than orders — she never met Tran and doesn\'t answer to him day-to-day; she answered to Senn.',
          plotPotential: 'AS PLAYED (S2 close): asked the PCs for help — her courier Brother Emmerin is missing four days in the Belum undercity carrying a sealed dispatch for Elder Vesper, and she can\'t go herself (her own faction is watching her since Senn died). Completing this opens the road to Vesper and reveals both Covenant factions are hunting the Kael-7 survivors. Session 3 material, not yet resolved.',
        },
        {
          name: 'Brother Emmerin',
          role: 'Covenant courier, missing in the Belum undercity',
          trait: 'Stubborn, quiet, carrying something he won\'t explain',
          secret: 'Carries a sealed dispatch meant for Elder Vesper. Held by the Molt gang, who don\'t know what he\'s carrying — they grabbed him only because he wouldn\'t stop walking through their turf.',
          appearance: 'Grey Covenant courier robes. Introduced S2 as a name only — not yet seen on screen.',
          voice: 'Not yet played.',
          plotPotential: 'DECIDED CANON (unplayed): alive, stubborn, on a hunger strike, has given up nothing about his mission. The Molt is running out of patience holding him for a ransom nobody\'s paid. Session 3 material — see "The Silent Courier."',
        },
      ],
    },
...
The Duskline — the merchant freighter the players escape on in Session 1 — is a Driftborn-affiliated ship.`,
      ...
      npcs: [
        ...
        },
        {
          ...
          plotPotential: 'RENAMED (post-S2): this thread was originally sketched under the name "Asha Kei" — that name is now canonically the Duskline deck boy played in Session 2 (see below), so this captain and her sealed-cargo mystery were renamed to Odessa Marr to avoid collision. The sealed cargo has been making sounds for six months. She has not opened it. This is unplayed prep, available whenever wanted — a ticking clock with legs.',
        },
        {
          name: 'Asha Kei',
          role: 'Duskline deck boy, ~14-15',
          trait: 'Quick, watchful, works hard — slight New-York-ish accent',
          appearance: 'Established S2 aboard the Duskline. Talked with Enkh during transit.',
          voice: 'Established S2: slight New-York-ish accent.',
          plotPotential: 'AS PLAYED (S2): Asha reminded Enkh strongly of Div — the planned "Kid" echo beat fired through Asha rather than through West as originally scripted, and landed well. A live, on-screen NPC now, not just prep.',
        },
      ],
    },
...
Linkin Park undertones: duality is her core tension. She was made to follow, but she was made well enough to see when following is wrong. "In the end it doesn't even matter" is a thing she might arrive at — not as despair, but as the discovery that she has to decide what matters herself.`,
  ...
  westOwnership: {
    ...
    howTheTruthArrives: 'Delivery channel: Ost (on Thessavar, hunting Tarek) learns the real legal tangle from Tarek — a Combine requisition agent who knows the lien, the Covenant purchase, all of it — and it percolates back to West over a session or two, IF Ost or Tarek can be reached/rescued (both are now captive — see `tarekOstCaptivity`). When it lands it is NOT "good news, you\'re free." It is: "you\'re being fought over, and the people fighting don\'t think you get a vote."',
  ...
  // ── THE LOCKET — DECIDED CANON (post-Session 2, reconciled with table play) ─
  locketState: {
    whatWasPlayed: 'S2 as-played: the locket grows warm near ENKH (West worked out the pattern). Since West\'s first touch — a small electric ZAP, the device registering them, exactly as the Lattice registered Tarek — West\'s baseline anxiety/trepidation has been replaced by a feeling of RIGHTNESS ("can\'t put a foot wrong"), magnified tenfold in direct contact. Table framing: the locket is "fixing" West\'s DNA / removing a genetic hindrance.',
    theReconciledTruth: `Not a screwup — the table framing and the original canon are the same thing seen from two angles. The locket is a paired Architect receiver that reads anyone it touches and tries to REPAIR them to Architect standards. For West it reads the Combine's engineered fear-leash — the cortisol spike that punishes acting against sanctioned purpose — as DAMAGE, and it is quieting it. So "fixing their DNA" is literally true. The key nuance to play: the locket is not making West confident. It is UN-MUTING a confidence that was always there under the conditioning. (For Enkh it reads PALE's affect-flattening as damage too — which is WHY it warms near him. It wants to fix him next. He hasn't touched it.)`,
    theTrap: 'The rightness-feeling is a dependency arc. West is borrowing selfhood from a crutch. If the locket is taken — and factions WILL come for it (the Combine\'s lineage-mapping interest, Tran\'s relic hunt, PALE) — the fear-leash snaps back and the flaw returns, harder for having been gone. The arc resolves the same way the ownership arc does: West eventually keeps the confidence WITHOUT the locket, because the locket was training wheels, not the bicycle. Do not let a device hand West personhood; let it show West what personhood will feel like once they claim it.',
    theRegistration: 'The zap = the Lattice network now has West indexed, same as Tarek. The broadcasting entity under Thessavar is AWARE of West (and, through proximity-reads, faintly of Enkh). Use sparingly: a dream with impossible geometry; a moment where the locket warms with no one near — as if something far away looked up. This is a slow line, not a fast one.',
    howToExplainItInFiction: 'Best expositor candidates, in order: (1) ELDER VESPER — Covenant relic knowledge + Tarek said trust her + it gives the Vesper road a personal payoff for West, not just plot. (2) A psychic — any trained psychic who touches or scans the locket feels the Lattice\'s signature and can say "this is a receiver, and it has registered you." A Synod confessor could do it — with the complication that whatever a Synod psychic learns, AURIS learns. (3) The PENUMBRA — they have Lenne\'s research; they could explain the array/receiver relationship in exchange for access to the locket. Each option leaks the info to a different faction. Choose by which faction you want aware of the locket next.',
    tarekWarningStillLive: 'Tarek\'s letter said: do not divide it, do not trust it. The rightness-feeling is exactly what "do not trust it" was warning about. When West eventually rereads that line, it should land like ice.',
  },

  // ── TAREK & OST — DECIDED CANON (pre-Session 3) ────────────────────────────
  tarekOstCaptivity: {
    whoAndWhy: 'PALE has Tarek — not AURIS. PALE already had a survey team logging anomalies at the primary node when Tarek touched the Lattice and got indexed; when he surfaced, PALE\'s own disaster-relief operation was the first responder on the water. He was picked up clean and deniable as a "shock victim requiring observation." No violence, no story anyone would question. AURIS has no established capture capability (it is an information/soft-power faction — chapels, confessions, the Tableau) and stays a SOFT rival: curious about the same signal, picking up whispers through the Synod\'s confessional network, never physically holding anyone.',
    ost: 'Ost found Tarek a few days later, pieced it together, sent the "Found Tarek. Leave now. Not safe." note (S1), then got picked up the same way. Whether Ost is held in the same PALE facility as Tarek is deliberately UNRESOLVED — a thread to dangle across sessions, not a fact to reveal yet.',
    where: 'A PALE Reconstruction & Wellness relief station in Kaeldrift — the same public program the Tableau praised for helping disaster victims. Tarek is a "patient," not visibly a prisoner.',
    whatHappenedToHim: 'PALE didn\'t torture it out of him — it never has to. It offered him the same thing it offers everyone: care, a scan, a Cognitive Lease, gentle and total. He is quietly becoming what Enkh already is.',
    whatHeTold: 'He\'s confirmed the fragment is real, that it\'s a paired Architect receiver, and that it indexed him and likely at least one other person by proximity. He has stayed DELIBERATELY VAGUE about which member of the security detail he actually handed it to — his one remaining act of agency, still protecting West. This is why PALE\'s knowledge stays a suspicion ("somewhere in that Kael-7 unit"), never certainty pointing at West specifically.',
    forTheTable: 'Keep this a mystery to the players for now — no confirmed, named antagonist reveal yet (it\'s still early campaign). Villain pressure around the locket should read as deniable/uncertain, not as a confirmed PALE operation, until the GM chooses to reveal it.',
  },
  ...
  castIndex: {
    'veronika':   { name: 'Veronika "The Saint"', blurb: 'Kaeldrift bartender; head of the River Below. Rescued the PCs; West has fallen in under her authority. S2 AS-PLAYED: partial break witnessed — grief/rage over "Red" ("I told him not to go... fuckin\' idiot"), no details given, claims ignorance about Still Gardens; both PCs ROLLED and know she\'s holding back. The full Saint reveal is STILL BANKED for S3+.', faction: 'river_below' },
    ...
    'ost':        { name: 'Ost (K7G2-87488-OST)', blurb: 'West\'s surviving unit-mate. Stayed on Thessavar to hunt for Tarek, found him, sent a warning — then went dark himself. Captured by PALE (see tarekOstCaptivity); players don\'t know this yet. Subject to the same Combine repossession writ as West.', faction: 'progenitor_combine' },
    'tarek':      { name: 'Requisition Agent Tarek', blurb: 'Combine agent who delivered West\'s unit; discovered what\'s in the vault; disappeared. Left the locket + letter. Captured by PALE, held as a "patient" at a Kaeldrift relief station — being quietly leashed like Enkh. Staying deliberately vague under questioning about which Kael-7 has the locket. Players don\'t know any of this yet.', faction: 'progenitor_combine' },
  ...
  backgroundThreads: [
    ...
    { id: 'bg-sealedcargo', name: 'Captain Odessa Marr\'s cargo', status: 'ticking',
      thread: 'Driftborn captain six months into hauling sealed containers she can\'t explain — warm to the touch, triple rate, paid upfront. She thinks she made a mistake. (The cargo is alive. She hasn\'t opened it.) [RENAMED from "Asha Kei" — that name is now canonically the Duskline deck boy, played in Session 2.]',
  ...
  session2: {
    ...
    missions: [
      ...
      },
      {
        ...
        offeredBy: 'halex',
        whyUs: 'Halex is Remembrance by faction — but she served personally on Arbiter Senn\'s staff, and her loyalty is to Senn, not to Marshal Tran or the Radiance eating through her faction\'s leadership. Senn is dead. Halex is trying, quietly and alone, to protect the last of Senn\'s unfinished work before Tran\'s wing can bury it or weaponize it. For West it\'s double-loaded: legitimate Covenant authority pulling on her architecture, versus Veronika\'s hold. For Enkh: the courier\'s dispatch is about the ruins, and the ruins are tangled up with whoever spent his exact debt as bait. Every road he cares about runs through what\'s under that ocean.',
        mainArcPayoff: 'This is the main quest wearing a side-quest coat. The dispatch reveals BOTH Covenant factions are hunting the Kael-7 survivors — the campaign\'s hunt begins here, AND it\'s the first hint that West\'s ownership is CONTESTED, not resolved (the Covenant asserts it bought the Kael-7 line; the Combine\'s repo team says otherwise — see westOwnership). It also puts West\'s architecture directly at odds with itself: Halex is legitimate Covenant authority, but she is asking the party to help her go around her own chain of command. Completing it opens the road to Elder Vesper (the "trust her" instruction made actionable = the likely Session 3 spine) — reached specifically BECAUSE a Remembrance sister chose Senn\'s memory over her faction\'s hardliners. And the read-or-don\'t-read choice on the sealed dispatch is West\'s whole arc in miniature.',
        hook: 'Sister Halex (Covenant nun, Remembrance — but Senn\'s former staff, not Tran\'s) spots West\'s detail insignia at the docks. Direct, tired, no games: courier Brother Emmerin went into the Belum undercity four days ago carrying a sealed dispatch meant to reach Elder Vesper. He hasn\'t come out. Halex can\'t go herself — her own faction is watching her since Senn died. She\'s asking, not ordering. (But she IS legitimate Covenant authority — West\'s architecture notices.)',
        talkingPoints: [
          'HALEX\'S ANGLE: she never met Tran and doesn\'t answer to him day-to-day — she answered to Senn. Since Senn died, the Remembrance leadership above her has gotten sharper, more certain, more willing to treat the ruins as a weapon rather than the "founding document" doctrine claims. She sees it (the Radiance, though she doesn\'t have that word for it) and it scares her. Reaching for Vesper is Halex going around her own chain of command out of loyalty to a dead woman, not doctrine.',
          ...
          'Halex, after: passage to Vesper can be arranged. First live route to the "trust Elder Vesper" instruction — reached through a Remembrance sister\'s private act of loyalty to Senn, not through Becoming politics.',
        ],
        checks: [
        ...
        reward: 'Emmerin + the dispatch. Halex\'s gratitude = arranged passage toward Vesper. West learns BOTH Covenant factions are hunting the Kael-7 survivors, and that not every Remembrance sister is a Radiance zealot.',
