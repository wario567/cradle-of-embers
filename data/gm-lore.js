...
Linkin Park undertones: duality is her core tension. She was made to follow, but she was made well enough to see when following is wrong. "In the end it doesn't even matter" is a thing she might arrive at — not as despair, but as the discovery that she has to decide what matters herself.`,
  ...
  castIndex: {
    ...
    'halex':      { name: 'Sister Halex', blurb: 'Covenant nun at Belum, leads a small group of sisters. Southern drawl (established S2). Asked the PCs for help at S2\'s close. ⚠ FACTION PENDING: prepped as Becoming, introduced at table as Remembrance — GM must rule before S3. If Becoming: Silent Courier mission as designed. If Remembrance: the ask becomes Tran-adjacent — possibly a trap.', faction: 'hollow_covenant' },
