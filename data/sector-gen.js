...
(function () {
  ...
  const LORE_NPCS = [
    ...
    { id: 'npc-darius', name: 'Darius Epps', role: 'Enkh\'s oldest friend; laborer', trait: 'Heavy drinker, loyal, misses the old Enkh', goal: 'Get Enkh out of PALE\'s ledger alive', hp: 6, maxHp: 6, notes: 'Aboard the Duskline with Enkh (boarded at Thessavar). PALE-skeptic. Knew Div. A live NPC in Session 2.', locationName: 'The Duskline (with the party)' },
    ...
    { id: 'npc-halex', name: 'Sister Halex', role: 'Hollow Covenant nun, Belum Freeport', trait: 'Southern drawl; direct, tired, no games', goal: 'Get help from the PCs (ask made at S2 close; details TBD)', hp: 6, maxHp: 6, notes: 'FACTION PENDING GM RULING: prepped Becoming, spoken at table as Remembrance. Legitimate Covenant authority either way — West\'s architecture notices.', locationName: 'Belum Freeport' },
    { id: 'npc-asha', name: 'Asha Kei', role: 'Duskline deck boy (Driftborn)', trait: '14-15, quick and watchful, slight New-York-ish accent', goal: 'Belong to the ship; be useful', hp: 3, maxHp: 3, notes: 'Talked with Enkh in transit — reminded him of Div. The "Kid" echo fired through him. (Not the sealed-cargo captain; that thread is Odessa Marr now.)', locationName: 'The Duskline' },
  ];
  ...
  const LORE_HOOKS = [
    ...
    { id: 'hook-ost', planetName: 'Thessavar', text: 'Ost stayed behind to find Tarek and got word out — the urchin\'s note ("Found Tarek. Leave now. Not safe.") was in Ost\'s hand (same Kael-7 lineage as West). Ost is alive. What did they find, and why isn\'t it safe?', status: 'Open' },
