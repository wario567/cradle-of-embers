...
- **DECIDED (going into S3): Ost and Tarek have been CAPTURED**, not just missing. **PALE has Tarek** — not AURIS. PALE's survey team was already logging anomalies at the primary node when Tarek touched the Lattice and got indexed; when he surfaced, PALE's own disaster-relief operation was the first responder on the water. He was picked up clean and deniable as a "shock victim requiring observation" — no violence, no story anyone would question. AURIS has no established capture capability (it's an information/soft-power faction — chapels, confessions, the Tableau) and stays a *soft* rival instead: curious about the same signal, picking up whispers through the Synod's confessional network, but never physically holding anyone. Ost found Tarek a few days later, pieced it together, sent the "Found Tarek. Leave now. Not safe." note, then got picked up the same way. Whether Ost is in the same facility as Tarek is still open — a thread to dangle, not resolve, in S3.
- **Where Tarek is:** a PALE Reconstruction & Wellness relief station in Kaeldrift — the same public program the Tableau praised for helping disaster victims. He's a "patient," not a prisoner in any visible sense.
- **What happened to him / what he told them:** PALE didn't torture it out of him — it never has to. It offered him the same thing it offers everyone: care, a scan, a Cognitive Lease, gentle and total. Under that he's confirmed the fragment is real, that it's a paired Architect receiver, and that it indexed him and likely at least one other person by proximity. **He has stayed deliberately vague about which member of the security detail he actually handed it to** — his one remaining act of agency, still protecting West. Thematic beat to hold onto: Tarek is quietly becoming what Enkh already is.
...
- **DECIDED: PALE's knowledge of the locket is a SUSPICION, not certainty.** Sourced from Tarek's intake, it only narrows things to "somewhere in that Kael-7 unit," not to West specifically (there were multiple Kael-7s in Senn's detail) — and Tarek is actively keeping it that vague. Do not have PALE act with certainty this session.
